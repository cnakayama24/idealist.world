...
function clicked (number)
{
  ...
  document.getElementById("toPlay").animate(
    ...
    switch (number)
    {
      case "1":
        {
          var audio = new Audio("/kanye/keys/1.mp3");
          audio.play(notes);      
        }
      break;
      case "2":
        {
          var audio = new Audio("/kanye/keys/2.mp3");
          audio.play(notes);      
        }
      break;
      case "3":
        {
          var audio = new Audio("/kanye/keys/3.mp3");
          audio.play(notes);      
        }
      break;
      case "4":
        {
          var audio = new Audio("/kanye/keys/10.mp3");
          audio.play(notes);      
        }
      break;
      case "5":
        {
          var audio = new Audio("/kanye/keys/5.mp3");
          audio.play(notes);      
        }
      break;
      case "6":
        {
          var audio = new Audio("/kanye/keys/6.mp3");
          audio.play(notes);      
        }
      break;
      case "7":
        {
          var audio = new Audio("/kanye/keys/7.mp3");
          audio.play(notes);      
        }
      break;
       case "8":
        {
          var audio = new Audio("/kanye/keys/8.mp3");
          audio.play(notes);      
        }
      break;
       case "9":
        {
          var audio = new Audio("/kanye/keys/9.mp3");
          audio.play(notes);   
        }
    }
  ...
  else if (notes[counter] === "9")
  {
    ...
    var audio = new Audio("/kanye/keys/sound.mp3");
